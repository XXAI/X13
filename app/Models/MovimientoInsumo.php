...
class MovimientoInsumo extends Model{
    ...
    protected $fillable = ['id','movimiento_id','stock_id','insumo_medico_id','direccion_movimiento','modo_movimiento','cantidad','user_id','bien_servicio_id','cantidad_anterior'];
