...
class MovimientoModificacion extends Model{
    ...
    protected $fillable = ['movimiento_id','estatus','motivo_modificacion','motivo_cancelado','motivo_revertido','solicitado_fecha','aprobado_fecha','cancelado_fecha','revertido_fecha','solicitado_usuario_id','aprobado_usuario_id','cancelado_usuario_id','revertido_usuario_id','estado_original','estado_modificado'];

    public function scopeConDescripciones(){
        return $this->select('movimientos_modificaciones.*','solicitado_usuario.name as solicitado_usuario','aprobado_usuario.name as aprobado_usuario','cancelado_usuario.name as cancelado_usuario','revertido_usuario.name as revertido_usuario')
