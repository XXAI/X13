...
export class ListaComponent implements OnInit {
  ...
  constructor(public mediaObserver: MediaObserver, private estatusAvanceService: EstatusAvanceRecepcionService, private sharedService: SharedService, private dialog: MatDialog) { }
  ...
  loadListadoPedidos(event?){
    ...
    this.estatusAvanceService.obtenerListaPedidos(params).subscribe(
      response =>{
        if(response.error) {
